...
const VideoBackground = ({ movieId }) => {
  ...
  return (
    <div className="w-full sm:w-screen z-10">
      <div className=" absolute inset-2 md:inset-10 bg-gradient-to-b from-black mb-0 h-[2%] md:h-[20%] sm:w-[93em] md:w-full blur-sm backdrop-blur-[0.5px] drop-shadow-[60px]"></div>
